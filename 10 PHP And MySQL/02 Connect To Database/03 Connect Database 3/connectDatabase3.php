<?php
	...
	$db_connect = mysqli_connect("localhost", "userName", "12345", "dataFormula");  // <-- Save Connection into variabel (NB: $db_conn, $connection, $link).
	...
	$result = mysqli_query($db_connect, "SELECT * FROM listShape");
